...
### Skills
- **Technologies**: PHP, Laravel, Vue.js, React, Angular, HTML, CSS, JavaScript, TypeScript, MySQL, Tailwind CSS, GraphQL, RESTful APIs
- **Tools**: Git, Symfony, Stripe, Apcopay, CakePHP, JWT Auth, Cron Jobs
